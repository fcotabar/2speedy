...
$sql ="SELECT p.Nombre, c.productoId,  sum(c.cantidad) AS cantidad, c.talla, p.descripcion, p.imagen, p.precio, p.categoriaId
            FROM carrito AS c
                            ...
                            <div class="col-5 mt-5">
                                <div class="border-start px-4">
                                    ...
                                    <div class="d-grid gap-2">
                                        <button class="btn btn-primary buy" type="button">Comprar</button>
                                    </div>
                                </div>                                
                            </div>
                        </div>
